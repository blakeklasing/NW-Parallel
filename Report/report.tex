...
reconceptualize approach to algorithm, possibly only put calculated items into instead of items to be calculated, in order to decrease #1 of dequeue/enqueues (less locking, less contention, more scalable).
...
The last method CAS was a considerable stumbling block. It was convoluted at first of how to implement it and figure out a concurrent method. 
